<template>
    <CommonCard3 colClass="col-xxl-4 col-md-6" cardClass="title-line" cardhaderClass="rating-header" pre="true"
        preClass="f-m-light mt-1" headerTitle="true" title="Heart Rating Bar" :desc="desc">

        ...
        <div class="cd-timeline-content">
            ...
            <div class="carousel slide" id="carouselExampleIndicators" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active"><img class="d-block w-100" src="/images/banner/2.jpg"
                            alt="office-work"></div>
                    <div class="carousel-item"><img class="d-block w-100" src="/images/banner/1.jpg" alt="office-work">
                    </div>
                    <div class="carousel-item"><img class="d-block w-100" src="/images/banner/3.jpg" alt="office-work">
                    </div>
                </div>

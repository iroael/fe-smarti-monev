<template>
    <CommonCard3 colClass="col-sm-12 box-col-12" cardClass="title-line" pre="true" preClass="f-m-light mt-1"
        headerTitle="true" title="Timeline" :desc="desc">
        <section class="cd-container" id="cd-timeline">
            ...
            <ThemeAdvanceTimelineDesignerSlider />
            <div class="cd-timeline-block">
...
let desc = ref<string>("This is a Yuri timeline chart.")
</script>
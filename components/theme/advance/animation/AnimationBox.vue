<template>
    <CommonCard3 colClass="col-sm-12" cardClass="title-line" pre="true" preClass="f-m-light mt-1" headerTitle="true"
        title="Modal With Animations" :desc="desc">
                    ...
                    <div class="card">
                        <div class="animate-widget">
                            ...
                            <div class="text-center p-25">
                                ...
                                <h3>It&apos;s Magic!!</h3> Select the animation options given below and then click on the
                                launch button.
                                <p></p>
                            </div>
                        </div>

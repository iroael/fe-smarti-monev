<template>
    <div class="row">
        <div class="col-sm-12">
            <div class="card hovercard text-center">
                ...
                <div class="user-image">
                    <div class="avatar"><img alt="" src="/images/user/7.jpg" id="profiletour"></div>
                    <div class="icon-wrapper"><i class="icofont icofont-pencil-alt-5"
                            data-intro="Change Yuri profile image here" id="update-profile-tour"></i></div>
                </div>
                <div class="info">
        ...
        <ThemeAdvanceTourFirstPost />
        <ThemeAdvanceTourSecondPost />
        <ThemeAdvanceTourThirdPost />
        <ThemeAdvanceTourLastPost />

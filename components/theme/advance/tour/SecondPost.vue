    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="profile-img-style">
                <div class="row g-2">
                    <div class="col-sm-8">
                        <div class="d-flex"><img class="img-thumbnail rounded-circle me-3" src="/images/user/7.jpg"
                    ...
                    <div class="col-sm-4 align-self-center mt-0 text-end">
                        <div class="social-media social-tour" data-intro="This is your social details"
                            id="social-bar-tour3">
                            <ThemeAdvanceTourSociaMedia time="10 Hours ago" />
                ...
                <div class="row g-3 mt-4 pictures" id="aniimated-thumbnials-2"><a class="col-sm-6"
                        ...
                        <div class="tour-blog"><img class="img-fluid rounded" src="/images/other-images/mountain.jpg"
                                alt="mountain"></div>
                    </a><a class="col-sm-6" href="javascript:void(0)">
                        <div class="tour-blog"><img class="img-fluid rounded" src="/images/other-images/sea.jpg" alt="sea">
                        </div>
                    </a></div>

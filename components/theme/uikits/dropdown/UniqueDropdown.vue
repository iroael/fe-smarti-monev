<template>
    <CommonCard3 colClass="col-sm-6" cardClass="title-line" cardbodyClass="rtl-dropdown" pre="true"
        preClass="f-m-light mt-1" headerTitle="true" title="Unique dropdown" :desc="desc">
...
let desc = ref<string>("Unique way to represent form dropdown and text dropdown.")
</script>
<template>
    <CommonCard3 colClass="col-xl-6 col-sm-12" cardClass="title-line" pre="true" preClass="f-m-light mt-2"
        headerTitle="true" title="Outline accordion" :desc="desc">
        <div class="accordion dark-accordion" id="simpleaccordion">
            <div class="accordion-item" v-for="(item, index) in simple" :key="index">
                <h2 class="accordion-header" :id="item.hederid">
                    <button class="accordion-button accordion-light-info txt-info" @click="toggleAccordion(index)"

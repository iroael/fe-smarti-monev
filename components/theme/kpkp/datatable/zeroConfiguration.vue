<template>
    <CommonCard3 colClass="col-sm-12" text="true" headerTitle="true" pre="true" preClass="f-m-light mt-1"
        title="Zero Configuration" :desc="desc">
                ...
                <table class="display table dataTable no-footer table-bordered" id="basic-1">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" sortable="namaPerumahan">Nama Perumahan</th>
                            <th scope="col" sortable="provinsi">Provinsi, Kabupaten/Kota.</th>
                            <th scope="col" sortable="kprSubsidi">KPR Subsidi</th>
                            <th scope="col">Kehunian</th>

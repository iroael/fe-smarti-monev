<template>
    <div class="row">
        ...
        <CommonCard3 colClass="col-sm-12" headerTitle="true" title="Hover Effect 14">
            <div class="row gallery my-gallery" id="aniimated-thumbnials13" itemscope>
                <figure class="col-md-3 col-6 img-hover hover-14" v-for="(n, index) in hover" :key="index"
                    itemprop="associatedMedia" itemscope @click="() => showImg(index)">
                    <a>
                        <div>

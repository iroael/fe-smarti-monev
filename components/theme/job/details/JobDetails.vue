                ...
                <div class="card-body">
                    <div class="d-flex"><img class="img-40 img-fluid m-r-20" :src="getImages(job.image)" alt="">
                        <div class="flex-grow-1">
                            <h6 class="f-w-600">
                                <nuxt-link :to="`/job_search/details/${job.id}`">{{
                                    job.title
                                }}</nuxt-link>
                                <span class="pull-right">
                                    <nuxt-link :to='`/job_search/apply/${job.id}`' class="btn btn-primary"
                                        type="button">Apply
                                    </nuxt-link></span>
                            </h6>
                    ...
                    <div class="job-description">
                        <button class="btn btn-primary me-1" type="button"><span><i class="fa fa-check"></i></span> Save
                            this
                            job</button>

<template>
    ...
    <div class="mb-2">
        ...
        <client-only>
            <multiselect v-model="value1" :options="multiple" :searchable="false" :group-select="true"
                :close-on-select="false" track-by="name" :disabled="disabled" label="name" placeholder="Pick a value">
            </multiselect>
        </client-only>

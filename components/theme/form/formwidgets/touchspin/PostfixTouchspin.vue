<template>
    <CommonCard3 colClass="col-xl-6" cardbodyClass="common-flex pre-post-touchspin bg-touchspin" cardClass="title-line"
        pre="true" preClass="f-m-light mt-1" headerTitle="true" title="Buttons with prefix and postfix" :desc="desc">
        ...
        <div class="input-group">
            <button class="decrement-touchspin btn-touchspin touchspin-warning" @click="secondaryDecrement()"><i
                    class="fa fa-minus"></i></button>
            <input class="input-touchspin spin-outline-primary" type="number" v-model="conter1">

<template>
    <CommonCard3 colClass="col-sm-12 col-md-6" headerTitle="true" cardClass="title-line" title="Clipboard on textarea">
        <div class="clipboaard-container">
            ...
            <div class="mt-3 text-end">
                <button class="btn btn-primary btn-clipboard mx-1" type="button" @click="copyTextareaInput"

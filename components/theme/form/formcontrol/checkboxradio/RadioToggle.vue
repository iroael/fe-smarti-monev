<template>
    <CommonCard3 colClass="col-md-6" pre="true" cardbodyClass="common-flex main-radio-toggle" preClass="f-m-light mt-1"
    ...
    <CommonCard3 colClass="col-md-6" pre="true" cardbodyClass="common-flex main-checkbox-toggle" preClass="f-m-light mt-1"

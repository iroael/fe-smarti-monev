<template>
    <CommonCard3 colClass="col-12" pre="true" preClass="f-m-light mt-1" headerTitle="true" title="Custom checkbox "
        :desc="desc">
        <div class="row g-3">
                    ...
                    <div class="form-check checkbox checkbox-primary ps-0 main-icon-checkbox">
                        <ul class="checkbox-wrapper">
                            <li v-for="(item, index) in iconcheckbox" :key="index">
                                ...
                                <label class="form-check-label" for="checkbox-icon"><i class="fa "

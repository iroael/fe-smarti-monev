<template>
    <CommonCard3 colClass="col-12" pre="true" preClass="f-m-light mt-1" headerTitle="true" title="Default checkbox "
        :desc="desc">
        <div class="row g-3">
...
let desc = ref<string>(" Use the <code>.form-check-input </code>and <code>.form-check-label </code>for checkbox.")
</script>
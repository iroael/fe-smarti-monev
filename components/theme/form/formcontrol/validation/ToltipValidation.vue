<template>
    <CommonCard3 colClass="col-sm-12" pre="true" preClass="f-m-light mt-1" headerTitle="true"
        title="Tooltip form validation" :desc="desc">
        <form class="row g-3 needs-validation custom-input" novalidate @submit.prevent="onCustomSubmit">
            ...
            <div class="col-md-4 position-relative">
                ...
                <input class="form-control" type="text"
                    ...
                    id="name1" placeholder="Your name" v-model="inputss.lastname.data">

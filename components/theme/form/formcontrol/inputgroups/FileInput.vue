<template>
    <CommonCard3 colClass="col-xl-6" pre="true" cardClass="height-equal"
        cardbodyClass="main-custom-form input-group-wrapper" preClass="f-m-light mt-1" headerTitle="true"
        title="Custom file input" :desc="desc">

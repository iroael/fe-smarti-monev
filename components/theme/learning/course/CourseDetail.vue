<template>
    <section class="comment-box">
        ...
        <ul>
            <li>
                <div class="d-flex align-self-center"><img class="align-self-center" src="/images/blog/comment.jpg"
            ...
            <li>
                <ul>
                    <li>
                        <div class="d-flex"><img class="align-self-center" src="/images/blog/9.jpg"
                                alt="Generic placeholder image">
                            <div class="flex-grow-1">
                                <div class="row">
                                    <div class="col-xl-12">
            ...
            <li>
                <div class="d-flex"><img class="align-self-center" src="/images/blog/4.jpg" alt="Generic placeholder image">
                    <div class="flex-grow-1">
                        <div class="row">
                            <div class="col-md-4 xl-100">
                                <h6 class="mt-0">Jolio Mark<span> ( Designer )</span></h6>

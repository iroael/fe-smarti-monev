...
export const photo: photos[] = [
    {
        title: "Johan Deo",
        descr: "An admin theme is a visually beautiful and practical design template created especially for a website's or application's backend.",
...
export const imgs: photos[] = [
    {
        title: "Portfolio Title",
        descr: "Using a camera's lens to record moments in time is the art form known as photography. To produce aesthetically striking photos, it entails the deft use of light, composition, and subject matter.",
        image: "lightgallry/01.jpg"
    },
    {
        title: "Portfolio Title",
...
export const imagearray: photos[] = [
    {
        image: "masonry/1.jpg",
        title: "Portfolio Title",
        descr: "Expert photographers have a thorough grasp of their gear and know how to get the best results by experimenting with different lenses, lighting setups, and post-processing software."
    },
    {
        image: "masonry/2.jpg",
        title: "Portfolio Title",

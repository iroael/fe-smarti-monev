<template>
    <div class="container-fluid">
        <div class="row">
            <ThemeIconsFontAwesomeIconsView @selected="icon_bar" />
            <ThemeIconsFontAwesomeCurrencyIcons @selected="icon_bar" />
            <ThemeIconsFontAwesomeWebAppIcons @selected="icon_bar" />
            <ThemeIconsFontAwesomeSpinnerIcons @selected="icon_bar" />
            <ThemeIconsFontAwesomeFormControl @selected="icon_bar" />
            <ThemeIconsFontAwesomeTextEditor @selected="icon_bar" />
            <ThemeIconsFontAwesomeDirectionalIcons @selected="icon_bar" />
            <ThemeIconsFontAwesomeVideoPlayer @selected="icon_bar" />
            <ThemeIconsFontAwesomeBrandIcons @selected="icon_bar" />
            <ThemeIconsFontAwesomeMedicalIcons @selected="icon_bar" />
        </div>
    </div>
...
useHead({
    title: "Icons Fontawesome | Yuri - Premium Nuxt Admin Template"
})

    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7 order-1 b-center bg-size"
                :style="{ backgroundImage: 'url(' + '/images/login/1.jpg' + ')', }"><img
                    class="bg-img-cover bg-center d-none" src="/images/login/1.jpg" alt="looginpage"></div>
            <div class="col-xl-5 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div> <nuxt-link class="logo" to="/"><img class="img-fluid for-light" src="/images/logo/logo.png"
                            ...
                            <form class="theme-form" novalidate @submit.prevent="validate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                        ...
                                        v-model="email" type="email" required placeholder="Test@gmail.com">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    </div><nuxt-link class="link" to="/pages/other/authentication/forget_password"> Forgot
                                        password?</nuxt-link>
...
useHead({
    title: " Validation Login | Smarti - Sistem Monitoring Rumah Terintegrasi"
})

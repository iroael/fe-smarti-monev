<template>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7 b-center bg-size" :style="{ backgroundImage: 'url(' + '/images/login/2.jpg' + ')' }"><img
                    class="bg-img-cover bg-center d-none" src="/images/login/2.jpg" alt="looginpage"></div>
            <div class="col-xl-5 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div><nuxt-link class="logo" to="/"><img class="img-fluid for-light"
                                    src="/images/logo/logo.webp" alt="looginpage"><img class="img-fluid for-dark m-auto"
                                    src="/images/logo/logo.webp" alt="looginpage"></nuxt-link></div>
                            ...
                            <form class="theme-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input position-relative">
                                        <input class="form-control" :type="type" name="login[password]" required
                                            placeholder="*********">
...
useHead({
    title: "Login Smarti | Sistem Monitoring Rumah Terintegrasi"
})

...
export const uselayoutStore = defineStore("layout", () => {
    ...
    function setLayout(val: any) {
        ...
        else if ((document.body.className == 'box-layout' || document.body.className == 'dark-only' || document.body.className == 'light box-layout') && val.class == 'dark-only') {
    ...
    if (process.client) {
        ...
        var primaryColor: string = useCookie('primary_color').value || layouts.value.color.primary_color;
        var secondaryColor: string = useCookie("secondary_color").value || layouts.value.color.secondary_color;
